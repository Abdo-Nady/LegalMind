...
export const documentAPI = {
    // List all documents
    list: async () => {
        return apiRequest('/ai/documents/');
    },

    // Get single document details
    get: async (id) => {
        return apiRequest(`/ai/documents/${id}/`);
    },
    ...
    // Delete a document
    delete: async (id) => {
        return apiRequest(`/ai/documents/${id}/`, { method: 'DELETE' });
    },
    ...
    chat: async (documentId, query, sessionId = null) => {
        ...
        return apiRequest(`/ai/documents/${documentId}/chat/`, {
            method: 'POST',
            body: JSON.stringify(body),
        });
    },

    // Get document clauses analysis
    getClauses: async (documentId) => {
        return apiRequest(`/ai/documents/${documentId}/clauses/`, {
            method: 'POST',
        });
    },
    ...
    getSummary: async (documentId) => {
        return apiRequest(`/ai/documents/${documentId}/summary/`, {
            method: 'POST',
        });
    },
};
...
export const sessionAPI = {
    ...
    get: async (id) => {
        return apiRequest(`/ai/sessions/${id}/`);
    },

    // Delete a session
    delete: async (id) => {
        return apiRequest(`/ai/sessions/${id}/`, { method: 'DELETE' });
    },
};
